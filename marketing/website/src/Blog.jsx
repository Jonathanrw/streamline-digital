...
const blogPosts = [
  { id: 1, title: 'The True Cost of Admin Drag: What Your Chaos is Costing You', date: '2026-06-15', category: 'Productivity', excerpt: 'Most solopreneurs lose 10+ hours a week to administrative chaos. Here\'s how to calculate exactly what it\'s costing your business — and how to stop the leak.', image: '📊', author: 'Streamline Team', readTime: '5 min' },
  { id: 2, title: 'From Solo to Scale: The 5 Systems Every Agency Needs', date: '2026-06-10', category: 'Agency', excerpt: 'Scaling from a solo operator to a small agency requires more than hustle. Here are the 5 critical systems you need to build before hiring your first contractor.', image: '🏗️', author: 'Streamline Team', readTime: '7 min' },
  { id: 3, title: 'How We Built a Content Engine That Runs Itself', date: '2026-06-05', category: 'Marketing', excerpt: 'Stop chasing the content calendar every week. This is the exact framework we use to batch, schedule, and repurpose 30 days of content in under 4 hours.', image: '✍️', author: 'Streamline Team', readTime: '6 min' },
